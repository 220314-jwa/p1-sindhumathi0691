...
package com.sindhuTRMS.controller;
...
public class RequestsController {
	private static EmployeeDAO empServ = new EmployeeDAOImpl();
	private static ReimbDAO reqServ = new ReimbDAOImpl();
	...
	public static void submitReimbursementRequest(Context ctx) {
		...
		Reimb request = new Reimb();
		
		System.out.println(data);
		request.setEvent_date(LocalDate.parse(data.get("eventDate")));
