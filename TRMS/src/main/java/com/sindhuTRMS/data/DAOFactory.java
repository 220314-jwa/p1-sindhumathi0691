...
public class DAOFactory {
    ...
    private static DeptHeadDAO DeptHeadDAO = null;
    ...
    public static DeptHeadDAO getDeptHeadDAO() {
    	if (DeptHeadDAO == null)
    		DeptHeadDAO = new DeptHeadDAOImpl();
    	return DeptHeadDAO;
    }
